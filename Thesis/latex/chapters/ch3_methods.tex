...
\textbf{Why support weighting rather than equal weighting? }Equal weighting would give every firing rule the same influence regardless of how broadly applicable it is. A rule covering 20\% of training years (the minimum support threshold adopted in this thesis) represents a pattern seen in roughly 18 years out of 89; a rule covering 28\% of years was observed in approximately 25 years. Giving equal weight to both would over-represent narrow, potentially less stable patterns. Support weighting is a principled way to account for statistical reliability without fully discarding less-common rules; they still contribute, but proportionally to their historical recurrence.
