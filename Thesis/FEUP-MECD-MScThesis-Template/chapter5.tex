...
Add in this section a reflection on how your work impacts the United Nations's Sustainable Development Goals (SDG). If you want to read about the SDG, visit the page: \url{https://sdgs.un.org/goals}. To obtain more information on the subject, we suggest the following courses:
\begin{itemize}
\item \url{ttps://dl4sd.org/course/view.php?id=4}
\item \url{https://www.classcentral.com/course/global-sustainable-development-10311}
\end{itemize}