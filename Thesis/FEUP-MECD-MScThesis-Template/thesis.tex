...
%% MECD options
\usepackage[mecd]{feupteses}                  % work version
%\usepackage[mecd,juri]{feupteses}             % juri version
%\usepackage[mecd,final]{feupteses}            % final version
...
%\usepackage[mecd,portugues]{feupteses}        % work version
%\usepackage[mecd,portugues,juri]{feupteses}   % juri version
%\usepackage[mecd,portugues,final]{feupteses}  % final version
...
\appendix
\include{appendix1}
\include{appendix-AItransparency}
